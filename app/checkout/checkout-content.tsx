    ...
    return (
      <div className="min-h-screen bg-[#F9F2EC] flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl text-[#8B5E3C] mb-4 font-serif">
            Memory Box not found
          </h1>
          <Link href="/" className="text-[#C49090] font-light">
    ...
    <div className="min-h-screen bg-[#F9F2EC]">
        ...
        <div className="max-w-2xl mx-auto px-6 py-6 flex items-center justify-between">
          ...
          >
            <img
              ...
              onError={(e) => {
                e.currentTarget.src = "data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%2264%22 height=%2264%22%3E%3Crect fill=%22%23F5EDE0%22 width=%2264%22 height=%2264%22/%3E%3Ctext x=%2250%25%22 y=%2250%25%22 text-anchor=%22middle%22 dy=%22.3em%22 font-size=%2232%22 fill=%22%23C49090%22%3E🎀%3C/text%3E%3C/svg%3E";
              }}
            />
          </Link>
          <Link
      ...
      <div className="pt-12 pb-20 px-6 max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-3xl overflow-hidden shadow-lg mb-8">
          ...
          <div className="p-8">
            <div className="mb-8">
              <h3 className="font-serif text-lg text-[#8B5E3C] mb-5">
                Τι περιλαμβάνει:
              </h3>
              <ul className="space-y-3">
                {template.features.map((feature: string, idx: number) => (
                  <li
                    key={idx}
                    className="flex gap-3 text-sm font-light text-[#7A6055] leading-relaxed"
                  >
                    <span className="text-[#C4A882] flex-shrink-0 mt-0.5">
                      ✓
                    </span>
                    <span>{feature}</span>
                  </li>
            ...
            <div className="text-center mb-8">
              <p className="text-xs tracking-widest uppercase text-[#B09880] mb-2">
                Τιμή
              </p>
        ...
        <div className="bg-[#F2E8DE] rounded-3xl p-8">
          ...
          <div className="space-y-4 text-sm font-light text-[#7A6055]">
            <div className="flex gap-3">
              ...
              <div>
                <p className="font-normal text-[#8B5E3C] mb-1">
                  Ολοκλήρωση Πληρωμής
                </p>
                <p className="text-[#B09880]">
                  Δημιουργία λογαριασμού και πρόσβαση σε editor
                </p>
              </div>
            </div>
            <div className="flex gap-3">
              ...
              <div>
                <p className="font-normal text-[#8B5E3C] mb-1">
                  Συμπλήρωση Memory Box
                </p>
                <p className="text-[#B09880]">
                  Πρόσθεσε φωτογραφίες και συμπλήρωσε τις ενότητες
                </p>
              </div>
            </div>
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-[#B09880]">
                  Κατέβασε το PDF και το ebook παραμύθι σου
                </p>
              </div>
            </div>
          </div>
